...
To keep the board dimensions as compact as possible, the buzzer and the UART interface board for the motors are mounted on the back side.
...
For the drivetrain, I am using four **Feetech STS3032** serial servos, as mentioned in [my previous post](../2026-06-01-FEETECH/). Huge thanks to Feetech for their support!
